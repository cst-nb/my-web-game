...
class Game:
    ...
    def draw(self):
                            ...
                            if 0 <= nr < GRID_SIZE and 0 <= nc < GRID_SIZE:
                                ...
                                if target and not target.wolf and not target.bomb:
                                    ...
                                    if recipe in MIX_RECIPE:
                                        ...
                                        pygame.draw.line(self.screen, res_color, (int(curr.x + 45), int(curr.y + 45)),
        ...
        self.screen.blit(self.font.render("Swipe or Arrows to Play / R to Reset", True, (100, 120, 140)),
                         (50, HEIGHT - 35))
            ...
            for e in pygame.event.get():
                ...
                if e.type == pygame.KEYDOWN:
                    if self.game_over and e.key == pygame.K_r:
                        ...
                        keys = {pygame.K_LEFT: "LEFT", pygame.K_RIGHT: "RIGHT", pygame.K_UP: "UP",
                                pygame.K_DOWN: "DOWN"}
